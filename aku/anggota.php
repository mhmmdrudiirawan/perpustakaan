...
// Hapus anggota jika permintaan hapus dikirimkan
if (isset($_GET['action'])) {
    if ($_GET['action'] == 'hapus' && isset($_GET['id'])) {
        ...
        // Redirect ke halaman edit anggota dengan membawa ID anggota
        header("Location: edit_anggota.php?id=" . $_GET['id']);
        exit;
    }
}
    ...
    <script>
        function confirmDelete(id) {
            if (confirm("Apakah Anda yakin ingin menghapus anggota ini?")) {
                window.location.href = "anggota.php?action=hapus&id=" + id;
            }
        }

        function goToEdit(id) {
            // Redirect ke halaman edit anggota dengan membawa ID anggota
            window.location.href = "anggota.php?action=edit&id=" + id;
        }
    </script>
</head>
<body>
...
<img src="img/buku1.png" alt="image" class="book-img">
            ...
            <h1 class="logo">Daftar Anggota</h1>
            <nav class="navbar">
            <ul class="nav-menu">
    ...
    <section class="content">
        <div class="container">
            ...
            <input type="text" id="searchInput" oninput="searchTable()" placeholder="Cari nama atau alamat...">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <button onclick=\"confirmDelete(" . $row['UserID'] . ")\">Hapus</button>
                                    <button onclick=\"goToEdit(" . $row['UserID'] . ")\">Edit</button>
                                  </td>";
                            echo "</tr>";
                            $no++;
                        }
