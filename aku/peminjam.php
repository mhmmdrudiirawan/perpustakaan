...
<header class="header">
        <div class="container">
        <img src="img/buku1.png" alt="image" class="buku-img">
    ...
    <section class="content">
        ...
        <tbody>
        <tr>
                <td><img src="img/pai12.jpg" alt="Bahasa Indonesia" class="book-img"></td>
                <td><img src="img/fisika.jpg" alt="Fisika" class="book-img"></td>
                <td><img src="img/mm.jpg" alt="Matematika" class="book-img"></td>
                <td><img src="img/pai.jpg" alt="Pendidikan Agama Islam" class="book-img"></td>
            </tr>
            <tr>
            <td><img src="img/bhsindo.jpg" alt="Bahasa Indonesia" class="book-img"></td>
                <td><img src="img/pai11.jpg" alt="Pendidikan Agama Islam" class="book-img"></td>
                <td><img src="img/pkn.jpg" alt="Bahasa Indonesia" class="book-img"></td>
                <td><img src="img/buku.jpg" alt="Bahasa Indonesia" class="book-img"></td>
            </tr>
        </tbody>
    </table>
    </section>
